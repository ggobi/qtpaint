...
To change the layout dynamically, one should manipulate the layout
object directly. The \Rfunarg{layout} method on \Rclass{Layer} returns
the layout instance. See the \Qt{} documentation for more details.
